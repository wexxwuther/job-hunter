...
|---|---|---|
| Dice | General tech, senior + contract roles | Strong for security, cloud, infra |
| Built In | City-anchored tech jobs (Austin, NYC, LA, etc.) | Company profiles with culture/perks |
| Hacker News "Who's Hiring" | Monthly thread, mostly startups | Search `[role] site:news.ycombinator.com hiring` |
| Wellfound (was AngelList) | Startup-heavy, equity-transparent | Strong for early-stage roles |
| Stack Overflow Jobs | Dev-focused | Smaller volume since 2022 |
| GitHub Jobs | Discontinued in 2021 | Skip; mention this if a user asks |
| We Work Remotely | Remote-only across many tech roles | Subscription required for some filters |
| Remote OK | Remote-only, all-industries | Lighter on enterprise |
| HN Jobs (whoishiring.io) | Aggregated HN "Who's Hiring" archive | Searchable across months |
...
| Board | Strengths | Notes |
|---|---|---|
| eFinancialCareers | IB, trading, asset management | Strong NYC/London/HK |
| Wall Street Oasis | Finance + consulting | Active forums + jobs |
| One Wire | Wealth management | |
| Selby Jennings | Senior finance roles | Recruiter-led |

## Marketing / Media / Creative

| Board | Strengths | Notes |
|---|---|---|
| Mediabistro | Editorial, marketing, communications | |
| CreativeCircle | Contract creative | Recruiter-curated |
| AdAge Job Board | Advertising | |
| AIGA Design Jobs | Design | |
| Coroflot | Design + creative ops | |
...
| Board | Strengths | Notes |
|---|---|---|
| Idealist | Nonprofits + social impact | Largest in this segment |
| NonProfitJobs | Smaller orgs | |
| The Bridgespan Group | Nonprofit leadership | Recruiter-led |
| Foundation List | Foundations + grant-making orgs | |

## Education

| Board | Strengths | Notes |
|---|---|---|
| HigherEdJobs | College + university | The dominant board for this segment |
| SchoolSpring | K-12 teaching + admin | |
| K12JobSpot | K-12 broader | |
| The Chronicle of Higher Education | Senior academic | |

## Trades / Operations / Skilled Labor

| Board | Strengths | Notes |
|---|---|---|
| iHireConstruction | Construction trades | Part of iHire network |
