---
name: Bug report
about: Something in the skill isn't working the way it should
title: '[bug] '
labels: bug
assignees: ''
---
...
Paste any error messages, agent output, or unexpected file contents (redact anything personal).
...
- Skill version: [check `_meta.json` `last_iteration` field]
